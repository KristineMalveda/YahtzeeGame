...
public class UpperLowerTotalScore {
	...
	public static void updatePlayer1Score(ArrayList<TextField> player1Fields, TextField player1Total) {
		...
		/*
		 * for (int i = 0; i < player1Fields.size(); i++) { if
		 * (!player1Fields.get(i).getText().isBlank()) { player1TotalScore +=
		 * Integer.valueOf(player1Fields.get(i).getText()); }
		 */
	}

	public static void updatePlayer2Score(ArrayList<TextField> player2Fields, TextField player2Total) {
	...
	public static void updatePlayer1LowerSectionScore(ArrayList<TextField> player1LowerFields,
			TextField player1TotalLower) {
	...
	public static void updatePlayer2LowerSectionScore(ArrayList<TextField> player2LowerFields,
			TextField player2TotalLower) {
