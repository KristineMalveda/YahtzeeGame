...
public class SpinTheDice {
	...
	public static int changePlayer(int activePlayer, Label lblPlayer1, Label lblPlayer2, ArrayList<Button> myButtons,
			Label lblWarning, Image[] gifs, Button spinBtn) {
		switch (activePlayer) {
		case 0:
			activePlayer = 1;
			break;
